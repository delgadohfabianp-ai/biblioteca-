...
import com.mycompany.biblioteca.modelo.LibroDao;
...
public class LibroControlador extends HttpServlet {
 private final LibroDao libroDao = new LibroDao();
    ...
    throws ServletException, IOException {
        request.setAttribute("libros", libroDao.vistarTodosLibros());
        request.getRequestDispatcher("/vistarLibros").forward(request, response);
    } // Cierre del método
