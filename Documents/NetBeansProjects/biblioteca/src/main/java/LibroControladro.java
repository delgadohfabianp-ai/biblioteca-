 ...
 * @author Usuario
 */
public class LibroControladro extends HttpServlet {
    /**
    ...
    private void listarTodosLibros(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException   {
       request.setAttribute("libro", new Libro());
    String NuevosLibros = null;
